defmodule Server.AccountsTest do
  ...
  alias Server.Accounts.{Player, PlayerToken}
  ...
  describe "register_player/1" do
    ...
    test "registers players with a hashed password" do
      ...
      {:ok, player} = Accounts.register_player(%{email: email, password: valid_player_password()})
  ...
  describe "change_player_registration/2" do
    ...
    test "allows fields to be set" do
      ...
      changeset =
        Accounts.change_player_registration(%Player{}, %{"email" => email, "password" => password})
